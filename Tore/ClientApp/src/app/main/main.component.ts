...
yoreDeyeSeifim:number[]=[14,11,1,7,3,4,1,1,1,3,4,2,6,6,3,12,3,20,8,4,5,2,6,20,3,2,1,1,2,4,8,11,10,10,17,7,5,25,6,10,9,6,10,2,6,5,12,5,3,4,7,5,5,13,10,21,12,2,3,33,4,2,21,14,10,6,15,21,6,3,4,6,1,3,6,1,1,3,6,9,5,10,17,3,10,11,2,4,4,8,9,1,9,7,5,3,9,7,4,9,4,7,3,14,
2,2,7,2,10,7,16,16,12,3,7,1,13,20,16,7,12,26,26,11,7,4,5,20,10,2,7,7,13,16,1,6,11,15,1,8,15,6,2,9,15,5,12,5,3,14,2,4,2,3,3,3,2,3,23,11,5,3,4,1,3,1,27,2,1,6,19,8,8,8,40,3,19,12,12,6,1,12,4,5,14,6,34,54,1,5,1,14,17,13,5,48,13,1,75,9,7,4,2,5,1,5,1,3,4,1,3,2,6,12,48,6,
...
{}
 ...
 PageSelect(page:any)
  ...
  SeifSpesifiSelect(seif)
  {
    ...
    this.userService.flagShowPath=false;
    this.router.navigate(['/question']);
  }
  RambamSelect(num)
  {debugger
